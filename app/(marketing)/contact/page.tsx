        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_320px] lg:gap-20">
          ...
          <aside className="flex flex-col gap-8 text-sm">
            <div className="flex flex-col gap-2">
              <h2 className="text-xs font-bold tracking-wide text-fg-subtle uppercase">Prefer email?</h2>
              <a
                href={`mailto:${site.contactEmail.value}`}
                className="text-base font-semibold text-brand underline-offset-4 hover:underline"
              >
            ...
            <div className="flex flex-col gap-2">
              <h2 className="text-xs font-bold tracking-wide text-fg-subtle uppercase">Where we are</h2>
              <p className="text-fg-muted">{site.location}. We work with clients anywhere; most meetings are remote.</p>
            </div>
            <div className="flex flex-col gap-2">
              <h2 className="text-xs font-bold tracking-wide text-fg-subtle uppercase">What happens next</h2>
