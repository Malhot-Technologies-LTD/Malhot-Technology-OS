-- Malhot OS — migration 6: projects, goals, mvp_items, milestones.
-- For a project that ALREADY has migrations 1-5 (the 7 existing tables).
-- Source: supabase/migrations/20260921100000_projects.sql
